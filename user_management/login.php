...
<html>
    ...
    <body>
        ...
        <span class="border border-primary">
            <form method="post" action="dashboard.php" style="margin:15%;" class="border-class">
                ...
                <div class="form-group row ">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="email" id="user_email" name="user_email" required><br>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="name" class="col-sm-2 col-form-label">Name:</label><br>
                    <div class="col-sm-10">   
                        <input class="form-control" type="text" id="name_of_user" name="name_of_user" required><br>
                    </div>
                </div>
                <div class="form-group row"> 
        ...
        <?php 
            ...
            if(isset($_POST[$user_email])){
                ...
                $sql = "select * from user_details where user_name = $userEmail AND user_password = $userPassword limit 1";
                $result = query($sql);
